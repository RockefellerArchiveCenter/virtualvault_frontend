# virtualvault_frontend

An application to provide access to restricted digitized content.
...
Install [git](https://git-scm.com/) and [yarn](https://yarnpkg.com/). Clone the repository.
    ...
    $ git clone https://github.com/RockefellerArchiveCenter/virtualvault_frontend.git
...
virtualvault_frontend comes with unit tests and linting. By running the `yarn prepare` script when
...
virtualvault_frontend is an open source project and we welcome contributions! If you want to fix a bug, or have an idea of how to enhance the application, the process looks like this:
